...
//   return (
//     <section className="w-full bg-[#1a1a1a] pl-16 pt-8 pb-0 overflow-hidden">
//       {/* Header */}
...
//         <Swiper
//           modules={[Navigation]}
//           className="rounded-l-4xl gap-8 max-h-400! rounded-b-none bg-white"
      ...
      {!loading && !error && categories && categories.length > 0 && (
        <Swiper
          ...
          breakpoints={{
            ...
            // original 2 side-by-side, single row
            768: {
              slidesPerView: 2,
