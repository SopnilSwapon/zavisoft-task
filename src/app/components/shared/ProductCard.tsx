  ...
  return (
    <div className="flex flex-col">
      ...
      <Link
        ...
        className="w-full bg-black hover:bg-[#222] h-10 text-white text-xs font-bold uppercase tracking-wider flex items-center justify-center gap-1.5 py-3 rounded-md transition-colors duration-200"
      >
